...
namespace ClientAPI.Validators
{
    public class DepositValidator : AbstractValidator<DepositCommand>
    {
        ...
        public DepositValidator(IUnitOfWork unitOfWork, IMessagePublisher messagePublisher)
        {
        ...
        private async Task<bool> HasValidAccount(DepositCommand request)
        {
        ...
        private async Task<bool> HasValidTransactionAmount(DepositCommand request)
        {
