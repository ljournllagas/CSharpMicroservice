        ...
        private static IHostBuilder CreateHostBuilder(string[] args)
        {
            var hostBuilder = Host.CreateDefaultBuilder(args)
                ...
                .ConfigureServices((hostContext, services) =>
                {
                    ...
                    services.AddDbContext<ClientDbContext>(options => options.UseSqlServer(sqlConnectionString));
                    ...
                    services.AddTransient<IMessageHandler>((svc) =>
                    {
                        ...
                        return new RabbitMQMessageHandler(rabbitMQHost, rabbitMQUserName, rabbitMQPassword, "RBank", "Client", ""); ;
                    });
